...
<head>       
        ...
        <audio controls="controls" hidden="hidden" autoplay="autoplay" loop="loop">
                <source src="钢琴-遇见.mp3" type="audio/mpeg" />
                </audio>
        <style>
            .zhufu{
                font-size: 30px;
            ...
            /* .html{
                background-image: url(fenhong.jpg);
               ...
               <div id="Layer1" style="position:absolute; width:100%; height:100%; background-color: #FA8CB0; z-index:-1" >      
                    <img src="xinfen.jpg" height="100%" width="100%"/>      
                    </div>    
        <head>
